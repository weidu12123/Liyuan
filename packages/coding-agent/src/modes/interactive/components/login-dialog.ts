import { getOAuthProviders, type OAuthDeviceCodeInfo } from "@liyuan/ai/oauth";
import { Container, type Focusable, getKeybindings, Input, Spacer, Text, type TUI } from "@liyuan/tui";
