...
Pi bundles core packages for extensions and skills. If you import any of these, list them in `peerDependencies` with a `"*"` range and do not bundle them: `@liyuan/ai`, `@liyuan/agent-core`, `@liyuan/agent-runtime`, `@liyuan/tui`, `typebox`.
