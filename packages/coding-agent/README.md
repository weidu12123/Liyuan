...
<p align="center">
  ...
  <a href="https://www.npmjs.com/package/@liyuan/agent-runtime"><img alt="npm" src="https://img.shields.io/npm/v/@liyuan/agent-runtime?style=flat-square" /></a>
</p>
...
```bash
npm install -g --ignore-scripts @liyuan/agent-runtime
```
...
- [@liyuan/ai](https://www.npmjs.com/package/@liyuan/ai): Core LLM toolkit
- [@liyuan/agent-core](https://www.npmjs.com/package/@liyuan/agent-core): Agent framework
- [@liyuan/tui](https://www.npmjs.com/package/@liyuan/tui): Terminal UI components
