...
```typescript
import { AuthStorage, createAgentSession, ModelRegistry, SessionManager } from "@liyuan/agent-runtime";
...
```bash
npm install @liyuan/agent-runtime
```
...
```typescript
import { createAgentSession, SessionManager } from "@liyuan/agent-runtime";
...
The `Agent` class (from `@liyuan/agent-core`) handles the core LLM interaction. Access it via `session.agent`.
...
```typescript
import { getModel } from "@liyuan/ai";
import { AuthStorage, ModelRegistry } from "@liyuan/agent-runtime";
...
```typescript
import { createAgentSession, DefaultResourceLoader } from "@liyuan/agent-runtime";
...
```typescript
import { createAgentSession } from "@liyuan/agent-runtime";
...
import { createAgentSession, defineTool } from "@liyuan/agent-runtime";
...
```typescript
import { createEventBus, DefaultResourceLoader } from "@liyuan/agent-runtime";
...
```typescript
import { createAgentSession, SettingsManager, SessionManager } from "@liyuan/agent-runtime";
