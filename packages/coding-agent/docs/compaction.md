...
For TypeScript definitions in your project, inspect `node_modules/@liyuan/agent-runtime/dist/`.
...
```typescript
import { convertToLlm, serializeConversation } from "@liyuan/agent-runtime";
