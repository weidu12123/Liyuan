...
import type { AssistantMessage, Model } from "@liyuan/ai";
...
vi.mock("@liyuan/ai/compat", async (importOriginal) => {
	const actual = await importOriginal<typeof import("@liyuan/ai/compat")>();
	return {
		...actual,
