...
**Source:** [`@liyuan/tui`](https://github.com/earendil-works/pi-mono/tree/main/packages/tui)
...
```typescript
import { CURSOR_MARKER, type Component, type Focusable } from "@liyuan/tui";
...
```typescript
import { Container, type Focusable, Input } from "@liyuan/tui";
...
Import from `@liyuan/tui`:

```typescript
import { Text, Box, Container, Spacer, Markdown } from "@liyuan/tui";
```
...
```typescript
import { matchesKey, Key } from "@liyuan/tui";
...
```typescript
import { visibleWidth, truncateToWidth } from "@liyuan/tui";
...
```typescript
import { getMarkdownTheme } from "@liyuan/agent-runtime";
...
For letting users pick from a list of options. Use `SelectList` from `@liyuan/tui` with `DynamicBorder` for framing.

```typescript
import type { ExtensionAPI } from "@liyuan/agent-runtime";
import { DynamicBorder } from "@liyuan/agent-runtime";
import { Container, type SelectItem, SelectList, Text } from "@liyuan/tui";
...
```typescript
import { BorderedLoader } from "@liyuan/agent-runtime";
...
For toggling multiple settings. Use `SettingsList` from `@liyuan/tui` with `getSettingsListTheme()`.

```typescript
import { getSettingsListTheme } from "@liyuan/agent-runtime";
import { Container, type SettingItem, SettingsList, Text } from "@liyuan/tui";
...
import { matchesKey, truncateToWidth } from "@liyuan/tui";
